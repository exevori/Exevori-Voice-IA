...
4. État distant au **16 septembre 2026, 22:52 UTC** : **010–020 appliquées et contrôlées** ; les comptes existants sont préservés après 018–020. Voir le [rapport final](MIGRATION_V1_EXECUTION_20260916.md), puis revérifier l'état avant recette. Ne pas rejouer 009–020. Les RPC de session de 018 sont présentes ; cette condition ne remplace pas les essais fonctionnels avec de vrais JWT et des comptes QA autorisés.
