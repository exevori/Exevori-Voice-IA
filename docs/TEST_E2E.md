...
4. État distant au **16 septembre 2026** : **010–017 appliquées et contrôlées ; 018 bloquée avant exécution sur autorisation sensible ; 019–020 non exécutées**. Voir le [rapport courant](MIGRATION_V1_EXECUTION_20260916.md), puis revérifier l'état avant recette. Ne pas rejouer 009–017. En particulier, **018 doit précéder ce backend** : l'absence des RPC de session entraîne volontairement un refus d'accès.
