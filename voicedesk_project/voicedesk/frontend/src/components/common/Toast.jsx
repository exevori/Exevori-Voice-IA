...
export default function Toast({ message, type = "success", onClose, duration = 5000 }) {
  ...
  return <div role={error ? "alert" : "status"} className={cn("fixed bottom-6 right-6 z-[100] flex max-w-[calc(100vw-3rem)] items-start gap-3 rounded-xl border bg-bg-elevated p-5 shadow-xl motion-safe:animate-fade-in", error ? "border-brand-red/30" : "border-brand-green/30")}>
